...
class NfcProxy {
  ...
  readTag = withAndroidPrompt(async () => {
    ...
    try {
      const nfcTechnologiesForAndroid = [
        NfcTech.Ndef, NfcTech.NfcA, NfcTech.NfcB, NfcTech.NfcF, NfcTech.NfcV, NfcTech.IsoDep, NfcTech.MifareClassic, NfcTech.MifareUltralight
      ]
      const nfcTechnologiesForiOS = [
        NfcTech.Ndef, NfcTech.NfcA, NfcTech.IsoDep //, NfcTech.MifareIOS, NfcTech.Iso15693IOS, NfcTech.FelicaIOS
      ]
      if (Platform.OS === 'ios') {
        await NfcManager.requestTechnology(nfcTechnologiesForiOS);
      } else {
        await NfcManager.requestTechnology(nfcTechnologiesForAndroid);
      }
