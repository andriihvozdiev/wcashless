...
const sq_button = require('../../assets/images/sq_button.png');
const sq_button_active = require('../../assets/images/sq_button_active.png');
...
const pay_icon = require('../../assets/images/pay.png');
      ...
      >
        ...
        }
        {
          <View style={{ alignItems: 'center' }}>
            <Text style={{ ...commonStyles.headerTitle, alignSelf: 'flex-start' }}>Other payment</Text>
              ...
              <View style={{ ...styles.amountContainer, ...styles.amountRow, paddingRight: 0 }}>
                ...
                <Input
                  ...
                  onChange={(event) => {
                    setTipPercent(0);
                    setTipAmount('');
                    const strValue = event.nativeEvent.text.trim();
                    const amountInt = parseInt(strValue.substring(1)) || 0;
            ...
            <View style={{ ...styles.amountContainer, ...styles.amountRow, ...styles.totalAmountContainer }}>
              ...
              <Input
                ...
                onChange={(event) => {
                  setTipPercent(0);
                  const strValue = event.nativeEvent.text.trim();
                  const tipAmountInt = parseInt(strValue.substring(1)) || 0;
              ...
              <View style={styles.buttonContainer}>
                <View style={{ width: '100%', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 16 }}>
                  <TouchableOpacity onPress={() => {
                    ...
                    <ImageBackground source={sq_button} imageStyle={{ resizeMode: 'stretch' }} style={{ width: 90, height: 90, flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                      <Image source={applepay} style={{ width: 40, height: 20, resizeMode: 'contain' }} />
                      <Image source={googlepay} style={{ width: 43, height: 23, resizeMode: 'contain', marginTop: 10 }} />
                    </ImageBackground>
                  </TouchableOpacity>
                  ...
                  <TouchableOpacity onPress={() => {
                    ...
                    <ImageBackground source={sq_button} imageStyle={{ resizeMode: 'stretch' }} style={{ width: 90, height: 90, flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                      <Image source={visa} style={{ width: 40, height: 20, resizeMode: 'contain' }} />
                      <Image source={mastercard} style={{ width: 40, height: 20, resizeMode: 'contain', marginTop: 10 }} />
                    </ImageBackground>
                  </TouchableOpacity>
                  ...
                  <TouchableOpacity onPress={() => {
                    ...
                    <ImageBackground source={sq_button} imageStyle={{ resizeMode: 'stretch' }} style={{ width: 90, height: 90, flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                      <Image source={pay_icon} style={{ width: 40, height: 40, resizeMode: 'contain' }} />
                    </ImageBackground>
                  </TouchableOpacity>
                </View>
                ...
                <TouchableOpacity onPress={() => navigation.goBack()}>
                  <ImageBackground source={other_payment} imageStyle={{ resizeMode: 'stretch' }} style={{ marginTop: 16, width: 220, height: 40, justifyContent: 'center', alignItems: 'center' }}>
                    <Text style={{ ...fontStyles.semibold, fontSize: 17, color: 'white' }}>WPAY</Text>
                  </ImageBackground>
                </TouchableOpacity>
