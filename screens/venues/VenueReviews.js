...
const VenueReviews = ({
  ...
  const [venueCategoryItems, setVenueCategoryItems] = useState([
    { label: 'Bar & Restaurant', value: 'category_bar', icon: category_bar },
    { label: 'Excursions & Tour', value: 'category_excursions', icon: category_excursions },
    { label: 'Shopping', value: 'category_shopping', icon: category_shopping },
    { label: 'Groceries', value: 'category_groceries', icon: category_groceries },
    { label: 'Entertainment', value: 'category_entertainment', icon: category_entertainment },
    { label: 'General', value: 'category_general', icon: category_general },
    { label: 'Services', value: 'category_services', icon: category_services },
    { label: 'Events & Festivals', value: 'category_events_festivals', icon: category_events_festivals },
    { label: 'Transportation', value: 'category_transportation', icon: category_transportation },
    { label: 'Stays', value: 'category_stays', icon: category_stays },
    { label: 'Health & Wellbeing', value: 'category_health', icon: category_health },
    { label: 'Live & Concerts', value: 'category_live', icon: category_live },
    { label: 'Arts & Exhibitions', value: 'category_arts', icon: category_arts },
  ]);
  ...
  useEffect(() => {
    ...
    setVenueCategory(venueCategoryItem);
      ...
      >
        ...
        <View style={styles.rowItem}>
          <View style={{ flexDirection: 'column' }}>
            ...
            <Text style={{ ...fontStyles.regular, fontSize: 15 }}>{venue?.phone}</Text>
          </View>
          <Image
            source={venue?.photo ? { uri: venue.photo.url } : header_logo}
            style={{ width: 40, height: 40, resizeMode: 'contain', borderWidth: 1, borderRadius: 20, borderColor: theme.COLORS.GREY_COLOR }}
          />
        </View>
        ...
        <View style={{ ...styles.rowItem, ...styles.rowBorder, height: 50, marginTop: 16 }}>
          <Text style={{ ...fontStyles.semibold, fontSize: 17 }}>Category</Text>
          {venueCategory &&
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              <Image source={venueCategory?.icon} style={{ width: 20, height: 20, resizeMode: 'contain' }} />
              <Text style={{ ...fontStyles.regular, fontSize: 17, color: theme.COLORS.BLUE, marginLeft: 8 }}>{venueCategory?.label}</Text>
            </View>
          }
        </View>
